...
/**
 * This class is used by {@link org.everit.expression.json.schema.loader.SchemaLoader} to resolve JSON
...
public class ReferenceSchema extends Schema {
  ...
  /**
   * Called by {@link org.everit.expression.json.schema.loader.SchemaLoader#load()} to set the referred root
